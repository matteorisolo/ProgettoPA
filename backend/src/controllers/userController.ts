...
export const getMyTokens = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const updateUserTokens = async (req: Request, res: Response, next: NextFunction) => {
    try {
