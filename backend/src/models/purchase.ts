...
export interface IPurchaseCreationAttributes extends Optional<IPurchaseAttributes, 'idPurchase' | 'recipientId' | 'recipientEmail' | 'createdAt'> {}

// Define the Purchase model class
class Purchase extends Model<IPurchaseAttributes, IPurchaseCreationAttributes> implements IPurchaseAttributes {
